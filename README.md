...
18 benchmark measures/editions were included in the previous snapshot; the catalog now tracks 20: SWE-rebench (rolling contamination-free issue window, selectable under Complex code changes) and ProgramBench (rebuild a program from its binary, new Building programs capability) were added on 2026-09-24.
